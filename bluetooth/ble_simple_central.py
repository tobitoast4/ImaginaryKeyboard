...
_UART_RX_CHAR_UUID = bluetooth.UUID("12345678-1234-5678-1234-56789abcdef0")
_UART_TX_CHAR_UUID = bluetooth.UUID("12345678-1234-5678-1234-56789abcdef0")
...
def demo():
    ...
    while central.is_connected():
        try:
            ...
            print("TX failed")
        i += 1
        time.sleep_ms(400 if with_response else 100)
